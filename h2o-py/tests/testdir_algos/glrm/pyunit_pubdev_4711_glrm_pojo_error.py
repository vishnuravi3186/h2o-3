...
def deepwater_export():
    frame =  h2o.import_file(path=pyunit_utils.locate("smalldata/airlines/allyears2k_headers.zip"))
...
if __name__ == "__main__":
    ...
    # pyunit_utils.standalone_test(deepwater_export)
